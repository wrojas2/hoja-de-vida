    ...
    <div class="card text-center">
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-4">
            <img src="https://thumbs.dreamstime.com/z/experiencia-que-aprende-concepto-del-icono-del-dibujo-de-la-exposici%C3%B3n-78547645.jpg" alt="" class="img-fluid rounded shadow" width="80%">
          </div>
        </div>
        <div class="row">
          <div class="col">
